...
- 2026-06-09 1.0 demo 发布收口完成：最新代码提交为 `eaeac6f fix: 补强预警同步并发刷新`；`npm run lint`、`npm run typecheck`、`npm run test`（37 个测试文件、131 个测试）、`npm run build`、`npm run db:check` 均通过；下一阶段进入 polish。
