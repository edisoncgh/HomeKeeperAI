...
项目已具备 Next.js 15.5、React 19、TypeScript、TailwindCSS、Prisma 6、SQLite、Vitest 的最小工程；`npm run prisma:generate`、`npm run prisma:push`、`npm run db:check`、`npm run lint`、`npm run typecheck`、`npm run test`、`npm run build` 均通过；已创建提交 `8cb0c3f feat: 初始化 M1.1 基础工程`。
